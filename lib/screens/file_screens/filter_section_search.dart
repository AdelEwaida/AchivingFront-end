...
class FillterFileSectionSearch extends StatefulWidget {
  const FillterFileSectionSearch({super.key});

  @override
  State<FillterFileSectionSearch> createState() => _FillterFileSectionState();
}

class _FillterFileSectionState extends State<FillterFileSectionSearch> {
  ...
  Future<void> search() async {
    ...
    // print("ONNNNN SSSSSSEEEEEEEEEEEEaaaaaarchhh");
    documentListProvider.setDocumentSearchCriterea(searchDocumentCriteria);
  }
}
